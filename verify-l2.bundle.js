...
`;
  ...
  frida_java_bridge_default.perform(function() {
    ...
    frida_java_bridge_default.use("android.os.Debug").isDebuggerConnected.implementation = function() {
      send("[hook] Debug.isDebuggerConnected -> false");
      return false;
    };
    const B = frida_java_bridge_default.use("sg.vantagepoint.a.b");
    B.a.implementation = function() {
      send("[hook] b.a (PATH scan) -> false");
      return false;
    };
    B.b.implementation = function() {
      send("[hook] b.b (build tags) -> false");
      return false;
    };
    B.c.implementation = function() {
      send("[hook] b.c (su files)  -> false");
      return false;
    };
    frida_java_bridge_default.use("sg.vantagepoint.a.a").a.implementation = function() {
      send("[hook] a.a (FLAG_DEBUGGABLE) -> false");
      return false;
    };
    const CodeCheck = frida_java_bridge_default.use("sg.vantagepoint.uncrackable2.CodeCheck");
    CodeCheck.bar.implementation = function(bytes) {
      const input = frida_java_bridge_default.use("java.lang.String").$new(bytes).toString();
    ...
    setTimeout(function() {
      ...
      const StringCls = frida_java_bridge_default.use("java.lang.String");
